...
using Test.Common.TestObjects.Utilities.Sql;
...
namespace Test.Common.TestObjects.Runtime
{
    public class RemoteWorkflowRuntime //: MarshalByRefObject
    {
        ...
        private void Init(Activity activity, TestWorkflowRuntimeConfiguration config)
        {
            ...
            _instanceHostTypeValue40 = XName.Get(WFInstanceScopeName, "Test.Common.TestObjects.Runtime.Hosting.Self.RemoteWorkflowRuntime");
